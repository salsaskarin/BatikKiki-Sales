...
<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __(' Form Tambah Pengeluaran Biaya') }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        ...
        <div class="input-group ">
          <input type="number" class="form-control" placeholder="" id="quantity" name="quantity" onchange="getTotal()" :value="old('quantity')" >
        ...
        <div class="input-group ">
          <span class="input-group-text" id="basic-addon1">Rp.</span>
          <input type="number" class="form-control" placeholder="" id="total" name="total" :value="old('total')" readonly >
